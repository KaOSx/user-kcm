...
void AddUserDialog::buttonCreate_clicked()
{
    ...
    // Add user
    KAuth::Action installActionAdd( QLatin1String( "org.kaosx.kcm.users.add" ) );
    installActionAdd.setHelperId( QLatin1String( "org.kaosx.kcm.users" ) );
    QVariantMap args;
    ...
    // Set password
    KAuth::Action installActionUsersChangePassword( QLatin1String( "org.kaosx.kcm.users.changepassword" ) );
    installActionUsersChangePassword.setHelperId( QLatin1String( "org.kaosx.kcm.users" ) );
    args.clear();
